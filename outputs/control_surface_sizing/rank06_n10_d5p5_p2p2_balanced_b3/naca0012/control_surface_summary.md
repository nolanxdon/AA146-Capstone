...
- Common-alpha freestream-referenced wing CLmax: `5.586`
- Equivalent stall speed: `4.525 m/s`
- Lift margin at 4 m/s: `-21.8 %`
- Alpha at CLmax: `13.83 deg`
- Post-stall 90% point: `19.75 deg`
- Post-stall drop over +5 deg: `0.437`
- Whole-wing C_M at CLmax: `-0.484`
- Whole-wing C_M at CLmax (blowing only): `0.110`
- Cambridge clean-strip immersion at CLmax: `1.000`
- Cambridge flap-strip immersion at CLmax: `0.999`
- Cambridge clean-strip jet margin at CLmax: `37.8 mm`
- Cambridge flap-strip jet margin at CLmax: `24.1 mm`
...
- Trim alpha at 10 m/s: `16.12 deg`
- Rolling moment derivative: `0.001717 /deg`
- Roll damping derivative: `-0.4173`
- Estimated roll rate at 14 deg: `33.0 deg/s`
- Estimated roll rate at 20 deg: `47.2 deg/s`
...
- Low-speed roll-damping proxy: `-3.2999`
- Low-speed roll-rate proxy at 14 deg: `13.9 deg/s`
- Low-speed roll-rate proxy at 20 deg: `19.8 deg/s`
