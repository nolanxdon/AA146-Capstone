...
- Common-alpha freestream-referenced wing CLmax: `5.897`
- Equivalent stall speed: `4.404 m/s`
- Lift margin at 4 m/s: `-17.5 %`
- Alpha at CLmax: `13.55 deg`
- Post-stall 90% point: `20.26 deg`
- Post-stall drop over +5 deg: `0.199`
- Whole-wing C_M at CLmax: `-0.792`
- Whole-wing C_M at CLmax (blowing only): `-0.485`
- Cambridge clean-strip immersion at CLmax: `1.000`
- Cambridge flap-strip immersion at CLmax: `0.999`
- Cambridge clean-strip jet margin at CLmax: `38.7 mm`
- Cambridge flap-strip jet margin at CLmax: `25.0 mm`
...
- Trim alpha at 10 m/s: `5.38 deg`
- Rolling moment derivative: `0.001717 /deg`
- Roll damping derivative: `-0.4571`
- Estimated roll rate at 14 deg: `30.1 deg/s`
- Estimated roll rate at 20 deg: `43.0 deg/s`
...
- Low-speed roll-damping proxy: `-3.6151`
- Low-speed roll-rate proxy at 14 deg: `12.7 deg/s`
- Low-speed roll-rate proxy at 20 deg: `18.1 deg/s`
