...
- Low-speed RPM: `10062.0`
- Cruise RPM: `9919.9`
- Available low-speed blown velocity: `15.12 m/s`
- Low-speed induced velocity from actuator-disk relation: `5.56 m/s`
...
- Common-alpha freestream-referenced wing CLmax: `5.828`
- Equivalent stall speed: `4.430 m/s`
- Lift margin at 4 m/s: `-18.5 %`
- Alpha at CLmax: `12.70 deg`
- Post-stall 90% point: `20.14 deg`
- Post-stall drop over +5 deg: `0.200`
- Whole-wing C_M at CLmax: `-0.686`
- Whole-wing C_M at CLmax (blowing only): `-0.220`
- Cambridge clean-strip immersion at CLmax: `1.000`
- Cambridge flap-strip immersion at CLmax: `1.000`
- Cambridge clean-strip jet margin at CLmax: `41.5 mm`
- Cambridge flap-strip jet margin at CLmax: `27.8 mm`
...
- Low-speed local dynamic-pressure ratio over aileron: `8.86`
- Low-speed effective local velocity over aileron: `11.90 m/s`
- Low-speed rolling-moment derivative proxy: `0.015209 /deg`
- Low-speed roll-damping proxy: `-3.6504`
